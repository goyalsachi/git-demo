...
* Open tsconfig.json and change outDir so that it points to <sahipro>/userdata/scripts/demo/typescript/out folder
...
This will create the <sahipro>/userdata/scripts/demo/typescript/out folder
